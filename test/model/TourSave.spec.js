...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TourSave', function() {
      beforeEach(function() {
        instance = new ApiDocumentation.TourSave();
      });

      it('should create an instance of TourSave', function() {
        // TODO: update the code to test TourSave
        expect(instance).to.be.a(ApiDocumentation.TourSave);
      });
